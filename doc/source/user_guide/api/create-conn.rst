...
If you need to access diagrams and their associated elements (available only on Ansys servers), you can use the :class:`SamApiConnector <ansys.sam.sysml2.diagrams.api.sam_api_connector.SamApiConnector>` connector.

.. literalinclude:: ../../_static/code/download-diagrams.py
    :lines: 41-45
    :language: python
    :caption: Connect to the SAM API server
