...
To find your organization ID, follow these steps:
...
- Find your organization ID in the URL of the page:
...
.. warning::
    ...
    Only copy the token after ``Bearer``.
...
5.  **Copy generated token:**
    When the token displays, click **Copy** to save it.
...
.. important::
    ...
    **Store this token in a secure location.** For security reasons, the token is not displayed again after you leave this page. You can generate a new one if needed.
...
.. note::
    ...
    Save your PAT in a secure location because it is not displayed again after you leave the page. You can generate a new one if needed.
