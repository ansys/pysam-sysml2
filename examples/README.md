...
This folder contains example `.kpar` models and Python scripts to demonstrate how to work with the SAM SysML v2 API.
...
## 🛠️ Importing a KPAR model into SAM editor

1. Open the SAM editor in your browser.
2. Select your organization (e.g., `MyOrga`).
3. Click on `New Project` → `SysML V2` → `Import File`.
4. In the `File to import` input, click `Choose File` and select the desired `.kpar` file.
