...
from ansys.sam.sysml2.meta_model.port_conjugation import PortConjugation


class TestPortConjugation:
    """Test class for Java class 'com.ansys.metamodel.sysml2.PortConjugation'."""

    @pytest.fixture
    def element(self):
        """Create test element with ID."""
        return PortConjugation("element_id")
