...
class RequirementUsage(ConstraintUsage):
    ...
    def requirement_definition(self) -> "RequirementDefinition":  # noqa: F821
        ...
        "RequirementDefinition"
            Value of property requirement definition.
        """
        return self._requirement_definition

    @requirement_definition.setter
    def requirement_definition(self, value: "RequirementDefinition"):  # noqa: F821
        """
        Set the requirement_definition property.
